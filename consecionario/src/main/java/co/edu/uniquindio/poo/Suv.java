...
public class Suv extends Vehiculo {
    ...
    public Suv(String marca, String modelo, CondicionVehiculo condicion, TipoTransmision transmision,
            ...
            Caracteristica sensorTraficoCruzado, Caracteristica asistentePermanenciaCarril, Caracteristica es4x4,double precio) {
